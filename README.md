...
<br /><br />
<p>
안녕하세요, 저는 개발자 [김형섭]입니다. 열정적인 풀 스택 웹 개발자입니다. 소프트웨어에 대한 나의 열정은 아이디어를 꿈꾸고 우아한 인터페이스로 실현하는 것입니다. 인간적인 소통을 중요시 여기고 사용자에게 좋은 경험을 제공하자라는 직업관을 가지고 있습니다.

또한, 원리위주의 개발을 지향하며 이를 통해 빈틈없는 비즈니스로직을 구성하고자 합니다. 구글링을 통한 오픈 소스 커뮤니티에서 많은 것을 배웠고 오픈 소스를 통해 어떻게 협업과 지식 공유가 이루어졌는지를 좋아합니다.
</p>
  
- 💼 IT 풀스택 개발자가 필요하세요? 연락주세요, [email](mailto:5jeam@naver.com) :)
- 💬 어떠한 것이든 문의해 주세요, 24시간 불철주야 상시응답대기중
<br>
